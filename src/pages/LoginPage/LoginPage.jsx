...
import insta_image from "../../images/phone.png";
// import insta_image from '../../images/insta_phone.svg'
...
import insta_logo from "../../images/logoinsta-white.png";
...
export default function LoginPage() {
  ...
  function handleSignOption() {
    setRenderLogin((prevRenderLogin) => !prevRenderLogin);
  }

  //code for the images slider:
  const images = [screenshot1, screenshot2, screenshot3, screenshot4];
  let currentIndex = 0;
  const [currentImage, setCurrentImage] = useState(screenshot1);
  const [isTransitioning, setIsTransitioning] = useState(false);

  useEffect(() => {
    const interval = setInterval(() => {
      //on passe d'image a image et si on attent la derniere, on revient a la premiere (%)
      currentIndex = (currentIndex + 1) % images.length;
      // console.log(currentIndex);
      //changer l'image et re-render la page

      setIsTransitioning(true); // Set transitioning state to true
      setTimeout(() => {
        setCurrentImage(images[currentIndex]);
        setIsTransitioning(false); // Set transitioning state to false after image change
  ...
  return (
    <>
      ...
      {/* <Grid item xs={12} className='login-page-container'> */}
      <div className='login-page-container'>
        {/* main content */}
        <div className='login-main'>
          {/* left side */}

          <section className='login-phone-image'>
            <img
              src={currentImage}
              alt='insta image'
              className={
                isTransitioning
                  ? "login-phone-slide image-transition"
                  : "login-phone-slide"
              }
            />
          </section>
          ...
          <div className='login-right-component'>
            ...
            <div className='login-signin'>
              <img src={insta_logo} alt='insta logo' className='login-logo' />
              {/* <InstagramLogo /> */}
              {/* <svg
	...
	>
		...
		></path>
            ...
            <div className='login-stores'>
              Install the App.
              <div className='login-stores-logos'>
                <a href='https://apps.apple.com/fr/app/instagram/id389801252'>
                  <img src={app_store} alt='app store' width='136px' />
                </a>
                <a href='https://play.google.com/store/apps/details?id=com.instagram.android&hl=fr&gl=US&pli=1'>
                  <img src={play_store} alt='play store' width='136px' />
                </a>
              </div>
            </div>
          </div>
